				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.jsp">
							...
							<img class="logo-alt" src="img/logo.jpeg" alt="logo">
						</a>
					</div>
					<!-- /Logo -->
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h1 class="white-text">We Are Creative Hub Of It Solution</h1>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="about">
						...
						<h3>Who We Are</h3>
						<p>We are the masters of our own destiny. We are the makers of our own fate. When we fully realize this truth, we will no longer search for the truth outside of ourselves. we are mainly focused on creating a unique things. Development is like magic for us.</p>
						<!-- <a href="#">Read more</a> -->
					</div>
				</div>
				<!-- /about -->
				...
				<div class="col-md-4">
					<div class="about">
						...
						<h3>What We Do</h3>
						<p>We do the things based on client orientation. What client needs from us we do same. Mainly focused on software development, web Development. In addition to we have HTML,PHP,ANDROID,Angular JS</p>
						<!-- <a href="#">Read more</a> -->
					</div>
				</div>
				<!-- /about -->
				...
				<div class="col-md-4">
					<div class="about">
						...
						<h3>Why Choose Us</h3>
						<p>Together everyone achieves more. We capture the attention of clients by showing them our ability, our team effort. We delivered the product in given time.</p>
						<!-- <a href="#">Read more</a> -->
					</div>
				</div>
				<!-- /about -->
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="./img/pr.jpg" alt="">
							<div class="overlay">
								<div class="team-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-google-plus"></i></a>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="contact">
						...
						<h3>Email</h3>
						<p>pradiphipparkar@gmail.com</p>
						<p>sengar.prashant5@gmail.com</p>
					</div>
				</div>
				<!-- /contact -->
				...
				<div class="col-sm-4">
					<div class="contact">
						...
						<h3>Address</h3>
						<p>Sasane Nagar, Hadapasar Pune</p>
					</div>
				</div>
				<!-- /contact -->
				...
				<div class="col-md-8 col-md-offset-2">
					<form action ="Mail.jsp" class="contact-form" method="post">
						...
						<textarea class="input" id ="message" name="message" placeholder="Message"></textarea>
						
						<button type="submit" class="main-btn" value="Send">Send Message</button>
						<!-- <button class="main-btn">Send message</button> -->
	<!-- <script type="text/javascript">
  function send() {
    var link = 'mailto:pradiphipparkar.com?subject=Message from '
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="footer-logo">
						<a href="index.jsp"><img src="img/logo-alt.png" alt="logo"></a>
					</div>
					/footer logo
